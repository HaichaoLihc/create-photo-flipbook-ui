Use $create-photo-flipbook-ui on the supplied page images into a polished,
responsive 3D page-turning photo-book website.

Preserve the supplied images exactly and keep their filename order. Treat the
first image as the front cover. Implement mouse, touch, button, and keyboard
