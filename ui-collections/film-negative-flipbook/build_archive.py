...
def document(photo_count: int, sleeves: list[str], page_count: int) -> str:
    ...
    asset_version = hashlib.sha256(b"".join((root / name).read_bytes() for name in ("styles.css", "archive-search.css", "film-inspector.css", "flipbook.js", "strip-arrangement.js", "archive-search.js", "film-inspector.js", "vendor/page-flip.browser.js"))).hexdigest()[:10]
...
<head>
  ...
  <link rel="stylesheet" href="archive-search.css?v={asset_version}">
  <link rel="stylesheet" href="film-inspector.css?v={asset_version}">
</head>
<body>
<main class="room">
...
<script src="vendor/page-flip.browser.js?v={asset_version}"></script>
<script src="strip-arrangement.js?v={asset_version}"></script>
<script src="film-inspector.js?v={asset_version}"></script>
<script src="flipbook.js?v={asset_version}"></script>
<script src="archive-search.js?v={asset_version}"></script>
</body>
</html>
"""
