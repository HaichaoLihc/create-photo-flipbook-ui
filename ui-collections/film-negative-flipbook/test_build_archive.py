...
class ImportTests(unittest.TestCase):
    def setUp(self):
        ...
        self.output.mkdir()
        self.source.mkdir()
        for name in ('styles.css', 'archive-search.css', 'film-inspector.css', 'flipbook.js', 'strip-arrangement.js', 'archive-search.js', 'film-inspector.js', 'vendor/page-flip.browser.js'):
